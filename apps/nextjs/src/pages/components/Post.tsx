...
import DeletePostModal from "~/pages/posts/components/modals/DeletePostModal";
import EditPostFormModal from "~/pages/posts/components/modals/EditPostFormModal";
import PostDetailModal from "~/pages/posts/components/modals/PostDetailModal";
    ...
    <>
      <Box bg="white" rounded="lg" p="5" mb="5" shadow="sm">
        ...
        <Heading
          ...
          onClick={!isDetail ? onDetailOpen : () => null}
          mb="2"
        >
          {title}
        </Heading>
